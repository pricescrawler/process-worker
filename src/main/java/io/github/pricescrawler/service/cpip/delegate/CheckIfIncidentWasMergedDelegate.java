...
public class CheckIfIncidentWasMergedDelegate implements JavaDelegate {
    @Autowired
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        delegateExecution.setVariable("isMerged", clearProductIncidentsService.checkIfIncidentWarMerged(productId.toString()));
    }
}
